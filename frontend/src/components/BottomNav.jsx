...
import { Home, Plus, BarChart2, Trophy, Settings } from 'lucide-react';
...
const BottomNav = ({ activeTab, setActiveTab, onQuickAdd, isDarkMode }) => (
    <div className="absolute bottom-0 w-full z-50">
        ...
        {/* Bottom Nav Bar */}
        <div className={`w-full px-2 py-4 grid grid-cols-5 items-center pb-8 rounded-t-3xl transition-all duration-300 ${isDarkMode
            ...
            {/* 3. CENTER SPACER for Floating Button */}
            ...
            {/* 5. Settings */}
            <div className="flex justify-center">
                <button onClick={() => setActiveTab('settings')} className={`flex flex-col items-center gap-1 transition-colors ${activeTab === 'settings' ? 'text-cyan-500' : isDarkMode ? 'text-gray-500 hover:text-gray-300' : 'text-gray-400 hover:text-gray-600'}`}>
